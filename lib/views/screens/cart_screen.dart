          ...
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return CartItemCard(
                ...
                onIncrement: () => cartProvider.incrementQuantity(item.product.id),
                onDecrement: () => cartProvider.decrementQuantity(item.product.id),
                onDelete: () => cartProvider.removeFromCart(item.product.id),
                onDismissed: () {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text('${removedItem.product.title} removed'), 
                      action: SnackBarAction(
                        label: 'UNDO', 
                        onPressed: () => cartProvider.addToCart(removedItem.product, quantity: removedItem.quantity)
                      )
                    )
                  );
                },
